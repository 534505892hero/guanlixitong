...
### 3.1 上传文件
将项目文件夹 `sk-research-system` 上传至服务器，例如 `/opt/sk-research`。
...
### 3.3 验证部署
1.  **访问本项目**: 浏览器打开 `http://服务器IP` (默认80端口)
...
**Q: 如何查看服务日志？**
A: 运行 `sudo docker-compose logs -f sk-research-app`
